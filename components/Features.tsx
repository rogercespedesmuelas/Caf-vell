...
const Features: React.FC = () => {
  return (
    <section id="why" className="py-24 bg-coffee-dark relative overflow-hidden border-t border-white/5">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {FEATURES.map((feature, index) => (
            <motion.div
              ...
              className="group p-8 bg-white/5 rounded-2xl shadow-lg hover:bg-white/10 transition-all duration-300 border border-white/10 text-center backdrop-blur-sm"
            >
